...
@section('secretary-content')
    <div class="space-y-6 max-w-4xl">
        ...
        <x-ui.card class="p-6">
            ...
            <form id="secretaryBlockForm" method="POST" action="{{ route('secretaria.horarios.bloquear.store') }}"
                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-neutral-200 bg-white">
                            @foreach ($blocks as $block)
                                <tr>
                                    <td class="px-4 py-3">{{ $block->medico?->nombres }} {{ $block->medico?->apellidos }}
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <x-ui.button type="button" variant="ghost" size="sm"
                                            class="text-red-600 hover:text-red-700" data-delete-block
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const populateDates = () => {
                    ...
                    resetSelect(startSelect, 'Selecciona hora de inicio');
                    resetSelect(endSelect, 'Selecciona hora de fin');
                ...
                const populateTimes = (dateValue) => {
                    resetSelect(startSelect, 'Selecciona un inicio');
                    resetSelect(endSelect, 'Selecciona un fin');

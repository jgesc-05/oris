...
@section('title', 'Servicios — Secretaría')

@section('secretary-content')
  <div class="space-y-6">
    <header class="space-y-2">
      <x-ui.badge variant="info" class="uppercase tracking-wide">servicios — secretaría</x-ui.badge>
      ...
      <p class="text-sm md:text-base text-neutral-600">
        Consulta rápidamente los servicios para brindar información o agendar citas.
      </p>
    </header>
              ...
              <div class="flex-1">
                ...
                <div class="mt-3">
                  <x-ui.button variant="primary" size="sm" class="rounded-full px-4 py-1 text-xs"
                    :href="route('secretaria.servicios.especialidad', ['especialidad' => $esp['slug']])">
                    Ver servicios
                  </x-ui.button>
                </div>
              </div>

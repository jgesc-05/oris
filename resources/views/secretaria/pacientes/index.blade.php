    ...
    <x-ui.card class="mb-4">
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-3">
        <div class="lg:col-span-2">
          ...
          <div class="relative">
            <input id="q" type="text" placeholder="Nombre, documento o correo" class="form-control pl-10" />
        ...
        <tbody class="bg-white divide-y divide-neutral-200">
          @forelse ($patients as $patient)
            <tr class="hover:bg-neutral-50 transition">
              <td class="px-4 py-3 text-neutral-900 font-medium">{{ $patient->nombres }} {{ $patient->apellidos }}</td>
          ...
          @empty
            <tr>
              <td colspan="5" class="px-4 py-6 text-center text-neutral-500">No hay pacientes registrados.</td>
            </tr>
          @endforelse
        </tbody>
      </table>

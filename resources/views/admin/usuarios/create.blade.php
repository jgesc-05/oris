        ...
        <form method="POST" action="{{ route('admin.usuarios.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="form-group">
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" class="form-control pr-12" autocomplete="new-password"
                            required>
                        <button type="button"
                            class="absolute inset-y-0 right-3 flex items-center text-neutral-500 hover:text-neutral-800"
                            data-toggle-password="password" aria-label="Mostrar u ocultar contraseña" aria-pressed="false">
                            <svg data-eye-open xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                            ...
                            <svg data-eye-closed class="hidden h-5 w-5" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="form-group">
                    ...
                    <div class="relative">
                        <input type="password" id="password_confirmation" name="password_confirmation"
                            class="form-control pr-12" autocomplete="new-password" required>
                        <button type="button"
                            class="absolute inset-y-0 right-3 flex items-center text-neutral-500 hover:text-neutral-800"
                            data-toggle-password="password_confirmation"
                            aria-label="Mostrar u ocultar confirmación de contraseña" aria-pressed="false">
                            <svg data-eye-open xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                    d="M1.458 12C2.732 7.943 6.523 5 12 5s9.268 2.943 10.542 7c-1.274 4.057-5.065 7-10.542 7S2.732 16.057 1.458 12z" />

    ...
    <x-ui.card class="max-w-3xl mx-auto">
        ...
        <form method="POST" action="{{ route('admin.usuarios.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {{-- Contraseña --}}
                <x-form.input name="password" type="password" label="Contraseña" :error="$errors->first('password')" />

                {{-- Confirmación de contraseña --}}
                <x-form.input name="password_confirmation" type="password" label="Confirmar contraseña" :error="$errors->first('password_confirmation')" />

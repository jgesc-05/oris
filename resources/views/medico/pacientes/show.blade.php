        ...
        <x-ui.card class="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-center gap-4">
                <div>
                    ...
                    <p class="text-sm text-neutral-600">{{ $patient->numero_documento }} •
                        {{ $patient->correo_electronico }}</p>
                </div>
            </div>
            ...
            <x-ui.card class="lg:col-span-2" title="Historial reciente" subtitle="Últimas interacciones en consulta">
                <div class="space-y-4">
                    @forelse ($timeline as $entry)
                        <div
                            class="flex flex-col md:flex-row md:items-center md:justify-between gap-2 border rounded-2xl px-4 py-3">
                            <div>
